/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9da81bbbe02af65e4a7a7ed5394230b2)
// Runtime types generated with workerd@1.20260409.1 2025-08-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameRoom" | "PrivateRoom" | "PresenceHub" | "MatchmakingRoom";
	}
	interface Env {
		DB: D1Database;
		FIREBASE_PROJECT_ID: "typiks";
		MATCHMAKER: DurableObjectNamespace<import("./src/index").MatchmakingRoom>;
		GAME_ROOM: DurableObjectNamespace<import("./src/index").GameRoom>;
		PRIVATE_ROOM: DurableObjectNamespace<import("./src/index").PrivateRoom>;
		PRESENCE_HUB: DurableObjectNamespace<import("./src/index").PresenceHub>;
	}
}
